# Tech Challenge • Fase 4: MED ANALYTICS <br> Estudo e análise de dados sobre a obesidade
...
Esse estudo visa expor e analisar os dados do arquivo "Obesity.csv"  e desenvolver um modelo de Machine Learnig que apoie uma equipe médica a prever e analisar possibilidade e casos de obesidade. 
• As regras adotadas nesta analise são:

<br>  **Requisitos:** <br><br>
 <img width="27" height="27" alt="image" src="https://github.com/user-attachments/assets/e76c0b3b-cbe3-4c62-adfb-44ff0b429c9e" />•  Utilização exclusiva da base de dados "Obesity.csv". </br>
